import fs from 'fs';
import type { ResponseLike } from 'random-quote-api/internal/to-file';
import { toFile } from 'random-quote-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('random-quote-api/core/uploads');
    await expect(
